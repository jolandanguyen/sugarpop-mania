...
public class EntityFactory {
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        return new Assassin(pos, assassinHealth, assassinAttack, assassinBribeAmount, assassinBribeRadius,
                allyAttack, allyDefence, assassinBribeFailRate);
    }
    ...
    public Hydra buildHydra(Position pos) {
        ...
        double hydraHealthIncreaseRate = config.optDouble("hydra_health", Hydra.DEFAULT_HEALTH_INCREASE_RATE);
        double hydraHealthIncreaseAmount = config.optDouble("hydra_attack", Hydra.DEFAULT_HEALTH_INCREASE_AMOUNT);
        return new Hydra(pos, hydraHealth, hydraAttack, hydraHealthIncreaseAmount, hydraHealthIncreaseRate);
    }
