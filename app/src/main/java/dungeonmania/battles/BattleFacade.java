...
public class BattleFacade {
    ...
    public void battle(Game game, Player player, Enemy enemy) {
        ...
        if (enemy instanceof Hydra) {
            ...
            HydraBattleStatistics enemyBaseStatistics = (HydraBattleStatistics) enemy.getBattleStatistics();
            BattleStatistics playerBattleStatistics = BattleStatistics.applyBuff(playerBaseStatistics, playerBuff);
            HydraBattleStatistics enemyBattleStatistics = enemyBaseStatistics;
            if (!playerBattleStatistics.isEnabled() || !enemyBaseStatistics.isEnabled())
                return;
            rounds = HydraBattleStatistics.hydraBattle(playerBattleStatistics, enemyBattleStatistics);
